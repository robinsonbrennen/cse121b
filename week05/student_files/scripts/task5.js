...
if (weekDay != 0 && weekDay != 6) {
    weekDayMessage = 'Hang in there!';
}
// Step 6: Using an else statement, set the message variable to 'Woohoo!  It is the weekend!'
else {
    weekDayMessage = 'Woohoo! It is the weekend!';
}
/* SWITCH, CASE, BREAK */
...
switch (weekDay) {
    ...
    case 6:
        ...
        break;
    default:
        newMessage = `Unknown!: ${weekDay}`;
        break;
}
/* OUTPUT */

// Step 1: Assign the value of the first message variable to the HTML element with an ID of message1
const message1 = document.querySelector("#message1").textContent = weekDayMessage;
// Step 2: Assign the value of the second message variable to the HTML element with an ID of message2
const message2 = document.querySelector("#message2").textContent = newMessage;
/* FETCH */
// Step 1: Declare a global empty array variable to store a list of temples
let listTemple = [];
// Step 2: Declare a function named output that accepts a list of temples as an array argument and does the following for each temple:
const output = (listTemple) => {
